    ...
    render() {
        return (
            <div className="temp24" >
                <div><p id="Time1">t1</p> <img src={storm} alt="storm-img" id="img1"/><p id="Deg1">d1</p></div>

                <div><p id="Time2">t2</p> <img src={storm} alt="storm-img"id="img2" /><p id="Deg2">d2</p></div>
                <div><p id="Time3">t3</p> <img src={storm} alt="storm-img" id="img3"/><p id="Deg3">d3</p></div>

                <div><p id="Time4">t4</p> <img src={storm} alt="storm-img" id="img4" /><p id="Deg4">d4</p></div>

                <div><p id="Time5">t5</p> <img src={storm} alt="storm-img" id="img5"/><p id="Deg5">d5</p></div>

                <div><p id="Time6">t6</p> <img src={storm} alt="storm-img" id="img6"/><p id="Deg6">d6</p></div>

                <div><p id="Time7">t7</p> <img src={storm} alt="storm-img" id="img7"/><p id="Deg6">d7</p></div>
            </div>
        );
